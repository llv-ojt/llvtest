...
Plugin URI: http://geek.ryanhellyer.net/multi-level-navigation/
Description: A WordPress plugin which adds a multi-level CSS based dropdown/flyout/slider menu to your WordPress blog. Visit the <a href="http://geek.ryanhellyer.net/multi-level-navigation/">WP Multi-level Navigation Plugin page</a> for more information about the plugin.
Author: Ryan Hellyer
Version: 2.3.6
...
define( 'MULTILEVELNAVIGATION_AD', "\n<!-- Multi-level Navigation Plugin v" . MULTILEVELNAVIGATION_VERSION ." by Ryan Hellyer ... http://geek.ryanhellyer.net/multi-level-navigation/ -->\n" );
