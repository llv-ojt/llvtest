...
echo '/*
  CSS generated via the Multi-level Navigation Plugin ... http://geek.ryanhellyer.net/multi-level-navigation/

  If you would like a similar menu for your own site, then please try the PixoPoint Web Development
  CSS generator for creating flyout, dropdown and horizontal slider menus ... http://geek.ryanhellyer.net/suckerfish_css/
