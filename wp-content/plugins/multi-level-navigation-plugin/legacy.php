...
function suckerfish() {
	...
	ob_end_clean();
	$suckerfish_html = str_replace('<!-- Multi-level Navigational Plugin by PixoPoint Web Development ... http://geek.ryanhellyer.net/multi-level-navigation/ -->', '', $suckerfish_html);
