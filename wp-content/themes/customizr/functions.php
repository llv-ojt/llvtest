...
class TC___ {
    ...
    function __construct() {
        ...
        $this->tc_core = apply_filters('tc_core', array(
            'fire' => array(
...
add_action('init', 'cptui_register_my_cpt_llvfeatures');

function cptui_register_my_cpt_llvfeatures() {
    register_post_type('llvfeatures', array(
        'label' => 'LLV Features',
        'description' => 'This is where all stuff about Lalaguna Villas should be written.',
        'public' => true,
        'show_ui' => true,
        'show_in_menu' => true,
        ...
        'map_meta_cap' => true,
        'hierarchical' => false,
        'rewrite' => array('slug' => 'llvfeatures', 'with_front' => true),
        'query_var' => true,
        'supports' => array('title', 'editor', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'thumbnail', 'author', 'page-attributes', 'post-formats'),
        'labels' => array(
            'name' => 'LLV Features',
            'singular_name' => 'Feature',
            'menu_name' => 'Resort features',
            ...
            'search_items' => 'Search LLV feature',
            'not_found' => 'No LLV Features Found',
            'not_found_in_trash' => 'No LLV Features Found in Trash',
